# DescribeDcdnDomainWebsocketTrafficData {#doc_api_dcdn_DescribeDcdnDomainWebsocketTrafficData .reference}

调用DescribeDcdnDomainWebsocketTrafficData获取加速域名的 websocket 网络流量监控数据，单位：byte。
...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=dcdn&api=DescribeDcdnDomainWebsocketTrafficData&type=RPC&version=2018-01-15)

## 请求参数 {#parameters .section}

|名称|类型|是否必选|示例值|描述|
|--|--|----|---|--|
|Action|String|是|DescribeDcdnDomainWebsocketTrafficData|操作接口名，系统规定参数，取值：**DescribeDcdnDomainWebsocketTrafficData**。
...
|TimeStamp|String|2017-12-10T20:00:00Z|时间片起始时刻。
 ...
 |
|WebsocketTraffic|Float|423304182|总流量。
...
``` {#request_demo}
http://dcdn.aliyuncs.com?Action=DescribeDcdnDomainWebsocketTrafficData&DomainName=example.com
